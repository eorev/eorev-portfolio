...
const WhatIDo = () => {
    return (
        <div className="max-w-none min-w-0 pb-8 opacity-95">
            <h1 className="text-4xl font-bold my-2">What I Do</h1>
            <p className="my-4 text-primary-200">Ethan. 21 y/o developer fascinated by the ever-changing world.</p>
            <p className="my-4 text-primary-200">I design, build, and publish products of reliability.</p>
            ...
            <h3 className="font-bold my-2">A note about computer science to me</h3>
            <p className="my-4 text-primary-200">
